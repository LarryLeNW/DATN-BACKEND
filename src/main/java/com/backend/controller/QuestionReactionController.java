...
public class QuestionReactionController {
	...
	@PostMapping
	ApiResponse<QuestionReaction> create(@RequestBody QuestionReactionCreation request) {
		return ApiResponse.<QuestionReaction>builder().result(questionReactionService.create(request)).build();
	}
